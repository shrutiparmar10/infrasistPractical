...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getImage: function getImage() {
      var image = this.form.image.length > 200 ? this.form.image : "images/employee/" + this.form.image;
      return image;
    },
    loadCountry: function loadCountry() {
      var _this3 = this;

      axios.get("loadCountry").then(function (_ref) {
        var data = _ref.data;
        _this3.countryOption = data;
      })["catch"](function () {});
    },
    loadState: function loadState() {
      var _this4 = this;

      axios.get("loadState").then(function (_ref2) {
        var data = _ref2.data;
        _this4.stateOption = data;
      })["catch"](function () {});
    },
    loadCity: function loadCity() {
      var _this5 = this;

      axios.get("loadCity").then(function (_ref3) {
        var data = _ref3.data;
        _this5.cityOption = data;
      })["catch"](function () {});
    }
  },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadEmployee: function loadEmployee() {
      ...
      axios.get("employee").then(function (_ref) {
        var data = _ref.data;
...
window.Multiselect = (vue_multiselect__WEBPACK_IMPORTED_MODULE_1___default());
...
var routes = [{
  ...
  path: "/add-employee",
  name: "add-employee",
  component: (__webpack_require__(/*! ./components/AddEmployee.vue */ "./resources/js/components/AddEmployee.vue")["default"])
}];
            ...
            "form",
            {
              on: {
                submit: function ($event) {
                  ...
                  _vm.editMode ? _vm.updateEmployee() : _vm.createEmployee()
                },
              },
            },
            [
                ...
                _c("div", { staticClass: "row" }, [
                    ...
                    _vm.feedback.name
                      ? _c("div", [
                          _c("span", {
                            ...
                            domProps: {
                              textContent: _vm._s(_vm.feedback.name[0]),
                            },
                          }),
                        ])
                      : _vm._e(),
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.feedback.country
                        ? _c("div", [
                            _c("span", {
                              staticStyle: { color: "red" },
                              domProps: {
                                textContent: _vm._s(_vm.feedback.country[0]),
                              },
                            }),
                          ])
                        : _vm._e(),
                      ...
                      _vm.feedback.state
                        ? _c("div", [
                            _c("span", {
                              staticStyle: { color: "red" },
                              domProps: {
                                textContent: _vm._s(_vm.feedback.state[0]),
                              },
                            }),
                          ])
                        : _vm._e(),
                      ...
                      _vm.feedback.city
                        ? _c("div", [
                            _c("span", {
                              staticStyle: { color: "red" },
                              domProps: {
                                textContent: _vm._s(_vm.feedback.city[0]),
                              },
                            }),
                          ])
                        : _vm._e(),
                  ...
                  _c("div", { staticClass: "col-md-4 form-group" }, [
                    ...
                    _vm._v(" "),
                    _vm.feedback.mobile_number
                      ? _c("div", [
                          _c("span", {
                            staticStyle: { color: "red" },
                            domProps: {
                              textContent: _vm._s(
                                _vm.feedback.mobile_number[0]
                              ),
                            },
                          }),
                        ])
                  ...
                  _c("div", { staticClass: "col-md-4 form-group" }, [
                    ...
                    _c("input", {
                      ...
                      domProps: { value: _vm.form.address_line1 },
                      on: {
                        input: function ($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.feedback.address_line1
                      ? _c("div", [
                          _c("span", {
                            staticStyle: { color: "red" },
                            domProps: {
                              textContent: _vm._s(
                                _vm.feedback.address_line1[0]
                              ),
                            },
                          }),
                        ])
                  ...
                  _c("div", { staticClass: "col-md-4 form-group" }, [
                    ...
                    _c("input", {
                      ...
                      domProps: { value: _vm.form.address_line2 },
                      on: {
                        input: function ($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "col-md-12 form-group" }, [
                    _c("div", [
                      ...
                      _vm._v(" "),
                      _c("div", [
                        _vm.form.image != "" && _vm.form.image != null
                          ? _c("img", {
                              ref: "image",
                              attrs: {
                                src: _vm.getImage(),
                    ...
                    _vm.feedback.image
                      ? _c("div", [
                          _c("span", {
                            staticStyle: { color: "red" },
                            domProps: {
                              textContent: _vm._s(_vm.feedback.image[0]),
                            },
                          }),
                        ])
                      : _vm._e(),
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { attrs: { for: "address1" } }, [
      _vm._v("Address 1"),
      _c("span", { staticStyle: { color: "red" } }, [_vm._v("*")]),
    ])
  },
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "card-header" }, [
            _c("h3", { staticClass: "card-title" }, [_vm._v("Employee List")]),
            _vm._v(" "),
            _c(
              "div",
              { staticStyle: { "text-align": "right" } },
              [
                _c("router-link", { attrs: { to: "/add-employee" } }, [
          ...
          _c("div", { staticClass: "card-body p-0" }, [
            _c("table", { staticClass: "table table-striped" }, [
              ...
              _c(
                "tbody",
                _vm._l(_vm.employeeData, function (emp) {
                  return _c("tr", { key: emp.id }, [
                    ...
                    _c("td", [
                      _vm._v(
                        "\n                    " +
                          _vm._s(emp.mobile_number) +
                          "\n                "
                      ),
                    ]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(emp.country))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(emp.state))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(emp.city))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(emp.address_line1))]),
                    _vm._v(" "),
                    _vm._m(1, true),
                  ])
                }),
